        ...
        <div id="page" class="clearfix">
				...
				<div id="site-header-inner" class="container-fluid"> 
					<div class="wrap-inner flex">
									...
									<ul id="menu-primary-menu" class="menu">
										<li class="menu-item menu-item-has-children menu-item-has-children-active current-menu-item">
											...
											<ul class="sub-menu">
												...
												<li class="menu-item current-item"><a href="home2.php">Home 2</a></li>
												<li class="menu-item"><a href="home3.php">Home 3</a></li>
											</ul>
										</li>
										<li class="menu-item ">
						...
						<div class="flat-button flat-button-style2">
									<a href="reservation.php" class="tf-button color-style1">book a table</a>
						</div>
					</div> 
				</div>
            </header>
			...
			<section class="page-title page-title-style2">		
                <div class="slider slider-style2">
					<img class="icon-bg1" src="assets/img/slider/icon1slider2.png" alt="images">
					<img class="icon-bg2" src="assets/img/slider/icon2slider2.png" alt="images">
					<img class="icon-bg3" src="assets/img/slider/icon3slider2.png" alt="images">
					<img class="icon-bg4" src="assets/img/slider/icon4slider2.png" alt="images">
										...
										<div class="page-tittle-slider distance flex">
										   <div class="content-slider">
												<div class="heading-tittle">
													...
													<div class="flat-button flat-button-style2">
														<a href="our-menu.php" class="tf-button color-text color-style2">explore our menu</a>
													</div>																
												</div>																			
										   </div>
										   <div class="images-slider1">
												<img src="assets/img/slider/imgfood2sliderhome2.png" alt="images">	
										   </div>									   	
											<div class="images-slider2">
												<img  src="assets/img/slider/imgfood1sliderhome2.jpg" alt="images">	
											</div>                                 
										</div>                          
									</div>
								</div><!-- item-->
				...
				<div class="container-fluid cleafix">
					<div class="row">
						...
						<div class="col-box col-30">
							<img class="imgbg_about1" src="assets/img/about-us/imgbg1home2.jpg" alt="images">
						</div>
						<div class="col-box col-40">
							<div class="wrap-content-style2">
								...
								<div class="image-signature">
									...
									<div class="signature">
										<img src="assets/img/about-us/signature.png" alt="images">
									</div>
								</div>
							</div>
						</div>
						<div class="col-box col-30">
							<div class="image-about-style02">
								<img class="imgbg_about2" src="assets/img/about-us/imgbg2home2.jpg" alt="images">
							</div>
						</div>
					</div>
				</div>
									...
									<div class="content-inner">
										<div class="col-tab flex">
											<div class="image wow fadeIn animated" data-wow-delay="0.3ms" data-wow-duration="1200ms">
												<img src="assets/img/flat-tab/img1tabhome02.jpg" alt="images"/>
											</div>	
											<div class="image2 wow fadeIn animated" data-wow-delay="0.3ms" data-wow-duration="1200ms">
												<img src="assets/img/flat-tab/img2tabhome02.jpg" alt="images"/>
											</div>																														
										</div>												
									</div>
									<div class="content-inner">
			...
			<section class="tf-section wrap-our-menu wrap-our-menu-style2">
				...
				<img class="imgbg1" src="assets/img/our-menu/img4bg-our-menu.jpg" alt="images">
				<img class="imgbg2" src="assets/img/our-menu/img3bg-our-menu.jpg" alt="images">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-12 cleafix">
							<div class="content-heading-wrap">
					...
					<div class="row">
						<div class="col-md-3">
							<div class="tf-icon-box tf-icon-box-style02 padding-right61  wow fadeInUp animated" data-wow-delay="0.3ms" data-wow-duration="600ms">
								<div class="icon-wrap margin-bt-18">
									<img src="assets/icon/iconlettece.png" alt="images">
								</div>
								<h5 class="heading">
									<a href="about.php">Fresh Food</a>
								</h5>
								<p class="sub-heading">
									Quis suspen ultrices gravida Risus commodo viverra maecen
								</p>
								<div class="btn-icon-box">
									<a class="color-style2" href="about.php"><i class="fal fa-arrow-right"></i></a>
								</div>
							</div>
						</div>					
						<div class="col-md-3">
							<div class="tf-icon-box tf-icon-box-style02 padding-right19 wow fadeInUp animated" data-wow-delay="0.3ms" data-wow-duration="800ms">
								<div class="icon-wrap margin-bt-18">
									<img src="assets/icon/icondelivery.png" alt="images">
								</div>
								<h5 class="heading">
									<a href="about.php">Home Delivery</a>
								</h5>
								<p class="sub-heading">
									Quis suspen ultrices gravida Risus commodo viverra maecen
								</p>
						...
						<div class="col-md-3">
							<div class="tf-icon-box tf-icon-box-style02 padding-left21 wow fadeInUp animated" data-wow-delay="0.3ms" data-wow-duration="1000ms">
								<div class="icon-wrap margin-bt-18">
									<img src="assets/icon/iconmoney.png" alt="images">
								</div>
								<h5 class="heading">
									<a href="about.php">Low Costs</a>
								</h5>
								<p class="sub-heading">
									Quis suspen ultrices gravida Risus commodo viverra maecen
								</p>
						...
						<div class="col-md-3">
							<div class="tf-icon-box tf-icon-box-style02 padding-left62 wow fadeInUp animated" data-wow-delay="0.3ms" data-wow-duration="1200ms">
								<div class="icon-wrap margin-bt-18">
									<img src="assets/icon/iconparty.png" alt="images">
								</div>
								<h5 class="heading">
									<a href="about.php">Event & Party</a>
								</h5>
								<p class="sub-heading">
									Quis suspen ultrices gravida Risus commodo viverra maecen
								</p>
								...
								<div class="swiper-wrapper">
										...
										<div class="slider-item ">
											<div class="post post2 wow fadeIn animated" data-wow-delay="0.3ms" data-wow-duration="1500ms">
												<div class="featured-post">
													<img src="assets/img/blog/img4blohhome01.jpg" alt="images">
												</div>
												<div class="content-post">
													...
													<div class="meta-post">
														<div class="author-style2 flex">
															<img src="assets/img/blog/admin.jpg" alt="images">
															<a href="shop-details.php" class="name">Williamson</a>
														</div>													
													</div>
													<h5 class="title">
													...
													<div class="btn-blog flat-button">
														<a href="shop-details.php" class="tf-button color-style3">Join events</a>
													</div>
												</div>
											</div>			
										</div><!-- item-->
									...
									<div class="swiper-slide">
										<div class="slider-item ">
											<div class="post post2 wow fadeIn animated" data-wow-delay="0.3ms" data-wow-duration="1500ms">
												<div class="featured-post">
													<img src="assets/img/blog/img5blohhome01.jpg" alt="images">
												</div>
												<div class="content-post">
									...
									<div class="swiper-slide">
										<div class="slider-item ">
											<div class="post post2 wow fadeIn animated" data-wow-delay="0.3ms" data-wow-duration="1500ms">
												<div class="featured-post">
													<img src="assets/img/blog/img6blohhome01.jpg" alt="images">
												</div>
												<div class="content-post">
													<div class="date-style2"><span>25 Aug 2021</span></div>
													<div class="meta-post">
									...
									<div class="swiper-slide">
										<div class="slider-item ">
											<div class="post post2 wow fadeIn animated" data-wow-delay="0.3ms" data-wow-duration="1500ms">
												<div class="featured-post">
													<img src="assets/img/blog/img7blohhome01.jpg" alt="images">
												</div>
												<div class="content-post">
													<div class="date-style2"><span>25 Aug 2021</span></div>
													<div class="meta-post">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
										<div class="slider-item slider-item-style2 img-brand">										
											<a href="#">
												<img class="img2" src="assets/img/brand/imgbrand7.png" alt="images">
											</a>		
										</div><!-- item-->
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="slider-item slider-item-style2 img-brand">										
											<a href="index.php">
												<img class="img2" src="assets/img/brand/imgbrand8.png" alt="images">
											</a>		
										</div><!-- item-->
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="slider-item slider-item-style2 img-brand">										
											<a href="index.php">
												<img class="img2" src="assets/img/brand/imgbrand9.png" alt="images">
											</a>		
										</div><!-- item-->
                                    </div>
                                    <div class="swiper-slide">
										<div class="slider-item slider-item-style2 img-brand">										
											<a href="index.php">
												<img class="img2" src="assets/img/brand/imgbrand10.png" alt="images">
											</a>		
										</div><!-- item-->
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="slider-item slider-item-style2 img-brand">										
											<a href="index.php">
												<img class="img2" src="assets/img/brand/imgbrand11.png" alt="images">
											</a>		
										</div><!-- item-->
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="slider-item slider-item-style2 img-brand">										
											<a href="index.php">
												<img class="img2" src="assets/img/brand/imgbrand12.png" alt="images">
											</a>		
										</div><!-- item-->
                                    </div>
                                </div>
			...
			<footer id="footer" class="footer-style02">
				<img class="iconbg1" src="assets/img/footer/iconbg1.png" alt="images">
				<img class="iconbg2" src="assets/img/footer/iconbg2.png" alt="images">
				<img class="iconbg3" src="assets/img/footer/iconbg3.png" alt="images">
				<img class="iconbg4" src="assets/img/footer/iconbg4.png" alt="images">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-2">
						...
						<div class="col-md-12">
							<div class="wrap-scroll wow fadeInUp animated" data-wow-delay="0.3ms" data-wow-duration="1000ms">
								<a id="scroll-top">
									<img src="assets/img/footer/iconuphome2@2x.png" alt="images" >
								</a>
							</div>
						</div>
						<!-- scroll-top -->
