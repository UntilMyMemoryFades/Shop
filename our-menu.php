									...
									<ul id="menu-primary-menu" class="menu">
										...
										<li class="menu-item menu-item-has-children menu-item-has-children-active current-menu-item">
											...
											<ul class="sub-menu">
												...
												<li class="menu-item current-item"><a href="our-menu.php">Our Menu</a></li>
			...
			<section class="tf-section wrap-gallery-our-menu">
				<div class="container-fluid">
					...
					<div class="flat-button style2 box-center">
						<a href="our-shop.php" class="tf-button color-style3">VIEW MORE GALLERY</a>
					</div>	
				</div>
			</section>
			<!-- Gallery -->
						...
						<div class="col-md-2">
							<div class="widget widget-link widget-footer">
								...
								<ul class="widget-list">
									...
									<li><a href="our-menu2.php">Food Lists</a></li>
								</ul>
							</div>														
						</div>
						<div class="col-md-2">
