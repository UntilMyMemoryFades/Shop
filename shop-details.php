									...
									<ul id="menu-primary-menu" class="menu">
										...
										<li class="menu-item menu-item-has-children menu-item-has-children-active current-menu-item">
											...
											<ul class="sub-menu">
												...
												<li class="menu-item current-item"><a href="shop-details.php">Shop Details</a></li>
											</ul>
										</li>
										<li class="menu-item ">
                        ...
                        <div class="col-md-6">
                            <div class="details_content">
								...
								<div class="tag-category">
									<ul class="category">
										<li>Category:</li>
										<li><a href="our-shop.php">Organic Juice</a></li>
									</ul>
									<ul class="tag">
										<li class="margin-right-67">Tags:</li>
										<li><a href="our-shop.php">Fruits</a><span>,</span></li>
										<li><a href="our-shop.php">Juice</a><span>,</span></li>
										<li><a href="our-shop.php">Drink</a></li>
									</ul>
								</div>								
                            </div>
                        </div>
