						...
						<nav id="main-nav" class="main-nav">
									<ul id="menu-primary-menu" class="menu">
										<li class="menu-item menu-item-has-children menu-item-has-children-active current-menu-item">
											<a href="#">Home</a>
											<ul class="sub-menu">
												<li class="menu-item current-item"><a href="index.php">Home 1</a></li>
								...
								<li class="col-box col-16">
									<div class="tf-icon-box tf-iconbox-category wow fadeInUp animated" data-wow-delay="0.3ms" data-wow-duration="500ms">
										...
										<div class="btn-icon-box">
											<a class="color-style2" href="our-shop.php"><i class="fal fa-arrow-right"></i></a>
										</div>
									</div>
								</li>
								<li class="col-box col-16">
			...
			<section class="tf-section wrap-gallery">
				<div class="container-fluid">
								...
								<div class="gallery-box h-100 wow zoomIn animated" data-wow-delay="0.3ms" data-wow-duration="1000ms">
									<div class="hover-effect active h-100">
										...
										<div class="content-box">
											<div class="icon">
												<a href="our-shop.php"><i class="fal fa-arrow-right"></i></a>
											</div>
											<div class="content">
					...
					<div class="flat-button box-center">
						<a href="our-shop.php" class="tf-button color-style3">view more photos</a>
					</div>	
				</div>
			</section>
			<!-- Gallery -->
                                        ...
                                        <div class="slider-item ">
                                            <div class="post wow fadeIn animated" data-wow-delay="0.3ms" data-wow-duration="1500ms">
                                                ...
                                                <div class="content-post bg-blog">
                                                    <ul class="meta-post">
                                                                <li class="author"><a href="shop-details.php">By Williamson</a></li>
                                                                <li class="date"><a href="shop-details.php">25 Aug 2021</a></li>
                                                    </ul>
                                                    <h6 class="title">
                                                    ...
                                                    <div class="btn-blog">
                                                        <a href="shop-details.php" class="tf-button color-style color-style4">read more</a>
                                                    </div>
                                                </div>
                                            </div>			
                                        </div><!-- item-->                              
