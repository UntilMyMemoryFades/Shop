						...
						<nav id="main-nav" class="main-nav">
									<ul id="menu-primary-menu" class="menu">
										...
										<li class="menu-item menu-item-has-children menu-item-has-children-active current-menu-item">
											<a href="#">Shop</a>
											<ul class="sub-menu">
												<li class="menu-item current-item"><a href="our-shop.php">Our Shop</a></li>
						...
						<div class="col-box col-25">
							...
							<div id="sidebar">
								...
								<div class="widget widget-list-product">
									...
									<ul>
										<li>
											<a href="our-menu.php">Vegateble Burger</a>
											<a href="our-menu.php">Chicken Soup</a>
											<a href="our-menu.php">Navaba Cakes</a>
											<a href="our-menu.php">Black Coffee</a>
											<a href="our-menu.php">Organic Juice</a>
											<a href="our-menu.php">Sea Fish Fry</a>
											<a href="our-menu.php">DMA Pasta</a>
										</li>
									</ul>
								</div>
								...
								<div class="widget widget_tags">
									...
									<ul>
										<li><a href="shop-details.php" class="active">Pasta</a></li>
										<li><a href="shop-details.php">Burger</a></li>
										<li><a href="shop-details.php">Fish</a></li>
										<li><a href="shop-details.php">Coffee</a></li>
										<li><a href="shop-details.php">Pizza</a></li>
										<li><a href="shop-details.php">Foods</a></li>
										<li><a href="shop-details.php">Organic</a></li>
										<li><a href="shop-details.php">Sea Fish</a></li>
									</ul>				
								</div>
							</div>
							<!-- sidebar -->
							...
							<div class="items-shop">						
								<div class="item-box ">
									<div class="item active">
										<div class="hover-effect active">
											<div class="image">
												<img src="assets/img/shop/tom_tai_xiu-4.jpg" alt="images">
											</div>
											<div class="product-actions">										
												<span class="exchange"><i class="fas fa-exchange-alt"></i></span>
												<a href="shop-details.php" class="tf-button color-text color-style1">ADD TO CART</a>
								...
								<div class="item-box ">
									<div class="item">
										<div class="hover-effect">
											<div class="image">
												<img src="assets/img/shop/banh_cuon-1.jpg" alt="images">
											</div>
											<div class="product-actions">										
												<span class="exchange"><i class="fas fa-exchange-alt"></i></span>
												<a href="shop-details.php" class="tf-button color-text color-style1">ADD TO CART</a>
								...
								<div class="item-box ">
									<div class="item">
										<div class="hover-effect">
											<div class="image">
												<img src="assets/img/shop/com_chien-2.jpg" alt="images">
											</div>
											<div class="product-actions">										
												<span class="exchange"><i class="fas fa-exchange-alt"></i></span>
												<a href="shop-details.php" class="tf-button color-text color-style1">ADD TO CART</a>
								...
								<div class="item-box ">
									<div class="item">
										<div class="hover-effect">
											<div class="image">
												<img src="assets/img/shop/suon_nuong-5.jpg" alt="images">
											</div>
											<div class="product-actions">										
												<span class="exchange"><i class="fas fa-exchange-alt"></i></span>
												<a href="shop-details.php" class="tf-button color-text color-style1">ADD TO CART</a>
								...
								<div class="item-box ">
									<div class="item">
										<div class="hover-effect">
											<div class="image">
												<img src="assets/img/shop/ca_nuong-7.jpg" alt="images">
											</div>
											<div class="product-actions">										
												<span class="exchange"><i class="fas fa-exchange-alt"></i></span>
												<a href="shop-details.php" class="tf-button color-text color-style1">ADD TO CART</a>
								...
								<div class="item-box ">
									<div class="item">
										<div class="hover-effect">
											<div class="image">
												<img src="assets/img/shop/goi_bap_chuoi-3.jpg" alt="images">
											</div>
											<div class="product-actions">										
												<span class="exchange"><i class="fas fa-exchange-alt"></i></span>
												<a href="shop-details.php" class="tf-button color-text color-style1">ADD TO CART</a>
								...
								<div class="item-box ">
									<div class="item">
										<div class="hover-effect">
											<div class="image">
												<img src="assets/img/shop/tom_danh_nhau-6.jpg" alt="images">
											</div>
											<div class="product-actions">										
												<span class="exchange"><i class="fas fa-exchange-alt"></i></span>
												<a href="shop-details.php" class="tf-button color-text color-style1">ADD TO CART</a>
